...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    mysqli_query($conn, "UPDATE lamaran SET status = '$action' WHERE id = $lamaranId");
    header("Location: lamaran_detail.php?id=$lamaranId");
    exit;
}
    ...
    <div class="navbar-container">
        <nav class="navbar">
            ...
            <div class="nav-right">
                ...
                <a href="lamaran_employer.php" class="nav-item active">Lamaran</a>
        ...
        <div class="lamaran-card">
            ...
            <div class="action-buttons">
                ...
                <?php if (!empty($lamaran['ijazah_path'])): ?>
                    <a href="<?= htmlspecialchars($lamaran['ijazah_path']) ?>" class="btn btn-secondary" download>Unduh
                        Ijazah</a>
                <?php endif; ?>
                <?php if (!empty($lamaran['transkrip_path'])): ?>
                    <a href="<?= htmlspecialchars($lamaran['transkrip_path']) ?>" class="btn btn-secondary" download>Unduh
                        Transkrip</a>
                <?php endif; ?>
